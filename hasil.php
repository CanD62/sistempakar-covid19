                ...
                <div class="container-fluid">
                    ...
                    ?>
                        ...
                        <div class="col-lg-4">
                           ...
                           <a href="cetak.php?code_sc=<?=$code_sc;?>" class="btn btn-primary btn-block">Cetak Sekarang</a>
                           <a href="index.php" class="btn btn-warning btn-block">Kembali ke Dashboard</a>
                        </div>
                        <!-- /.col-lg-4 -->
                    </div>
                    <!-- /.row -->
